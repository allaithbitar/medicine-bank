const STRINGS = {
  ...
  already_exists_for_patient: 'الرقم الوطني موجود بالفعل عند مستفيد اخر',
  phone_already_exists_for_patient: 'رقم الهاتف موجود بالفعل عند مستفيد اخر',
  ...
  show_less: 'عرض أقل',
  beneficiary_information: 'معلومات المستفيد',
