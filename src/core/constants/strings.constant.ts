const STRINGS = {
  ...
  login: 'تسجيل الدخول',
  logout: 'تسجيل الخروج',
  disclosures: 'كشوفات غير منجزة',
  priority: 'الأولية',
  created_at: ' تاريخ الإضافة',
  and: 'و',
  Patient_created_at: ' تاريخ اضافة المريض',
  disclosure_created_at: 'تاريخ إضافة الكشف',
  disclosure_updated_at: 'تاريخ اخر تعديل للكشف',
  disclosure_scout: 'الكشّاف',
  updated_at: 'تاريخ اخر تعديل',
  patient_updated_at: 'تاريخ اخر تعديل للمريض',
  ...
  patient_about: 'معلومات عن المريض',
  ...
  the_custom_rating: 'التقييم المخصص',
  custom_rating: 'تقييم مخصص',
  visits: 'الزيارات',
  added_successfully: 'تمت الإضافة بنجاح',
  edited_successfully: 'تم التعديل بنجاح',
  action_done_successfully: 'تمت العملية بنجاح',
  something_went_wrong: 'حصل خطأ ما',
  beneficiaries: 'المرضى',
  beneficiary: 'المريض',
  employees: 'الموظفين',
  employee: 'الموظّف',
  add_beneficiary: 'إضافة مريض',
  add_employee: 'إضافة موظف',
  no_data_found: 'لم يتم العثور على اي بيانات',
  beneficiary_doesnt_have_any_disclosure: 'لايملك هذا المريض اي كشف',
  manager: 'إداري',
  supervisor: 'مشرف',
  scout: 'كشّاف',
  the_scout: 'الكشّاف',
  ...
  add_missing_medicine: 'إضافة دواء غير موجود',
  add_missing_medicine_with_name: 'إضافة "{name}"',
  intake_frequency: 'وتيرة الاستهلاك',
  dose: 'الجرعة',
  ...
  new_audio_recording: 'تسجيل صوتي جديد',
  audio_deleted: 'تم حذف التسجيل الصوتي',
  audio_deleted_and_replaced: 'تم حذف التسجيل الصوتي واستبداله بتسجيل جديد',
  ...
  no_family_members: 'لا يوجد أفراد عائلة لهذا المريض',
  disclosure_properties: 'خصائص الكشف',
  action_type: 'تمت عملية',
  edit_done: 'تم التعديل',
  edited_fields: 'الحقول المعدلة',
  home_condition_status: 'حالة السكن',
  home_condition_status_note: 'ملاحظة حالة السكن',
  home_status: 'وضع الملكية',
  home_status_note: 'ملاحظة وضع الملكية',
  update_column_rating_id: 'التقييم',
  ...
  update_column_appointment_date: 'تاريخ المراجعة',
  ...
  update_column_cons: 'السلبيات',
  update_column_pros: 'الايجابيات',
  update_column_meds: 'الأدوية',
  update_column_note: 'الملاحظة',
  update_column_audio: 'الصوت',
  ...
  house_ownership_note: 'ملاحظة ملكية السكن',
  ...
  offline_updates: 'التحديثات غير المتزامنة',
  all_synced: 'جميع التغييرات متزامنة',
  insert_operation: 'إضافة',
  update_operation: 'تعديل',
  changed_values: 'البيانات المُعدّلة',
  added_values: 'البيانات المضافة',
  archive_number: 'رقم الأرشفة',
  rating_note: 'ملاحظة التقييم',
  ...
  accountant: 'محاسب',
  schema_at_least_one_phone: 'يجب ادخال رقم هاتف واحد على الأقل',
  change_password: 'تغيير كلمة المرور',
  current_password: 'كلمة المرور الحالية',
  new_password: 'كلمة المرور الجديدة',
  confirm_password: 'تأكيد كلمة المرور',
  recording: 'جاري التسجيل',
  already_exists_for_patient: 'الرقم الوطني موجود بالفعل عند مريض اخر',
  phone_already_exists_for_patient: 'رقم الهاتف موجود بالفعل عند مريض اخر',
  loading_recommendation: 'جاري تحميل التوصية...',
  scout_recommended: 'تم اختيار الكشاف الموصى به',
  additional_information: 'معلومات إضافية',
  optional_fields: 'حقول اختيارية',
  show_more: 'عرض المزيد',
  show_less: 'عرض أقل',
  beneficiary_information: 'معلومات المريض',
  disclosure_information: 'معلومات الكشف',
  beneficiary_not_found: 'المريض غير موجود',
  move_disclosures: 'نقل الكشوفات',
  move_disclosures_title: 'نقل الكشوفات بين الكشافين',
  from_scout: 'من الكشاف',
  to_scout: 'إلى الكشاف',
  select_areas_optional: 'اختر المناطق (اختياري)',
  move_all_areas_note: 'ترك المناطق فارغاً سيؤدي إلى نقل جميع الكشوفات في كل مناطق الكشاف القديم الى الكشاف الجديد',
  move_confirmation_title: 'تأكيد نقل الكشوفات',
  move_confirmation_message: 'هل أنت متأكد من نقل الكشوفات من الكشاف المحدد إلى الكشاف الجديد؟',
  cannot_select_same_scout: 'لا يمكن اختيار نفس الكشاف للنقل من والنقل إلى',
  payments: 'المدفوعات',
  eligible_payments: 'المستحقات',
  payment_history: 'سجل المدفوعات',
  mark_as_paid: 'تحديد كمدفوع',
  paid_at: 'تاريخ الدفع',
  completed_at: 'تاريخ الإكمال',
  mark_as_paid_confirmation: 'هل أنت متأكد من تحديد جميع المستحقات الظاهرة كمدفوعة؟',
  mark_as_paid_confirmation_desc: 'سيتم تحديد جميع الكشوفات المستحقة للكشاف المحدد كمدفوعة',
  eligible_disclosures: 'الكشوفات المستحقة',
  no_scout_selected: 'الرجاء اختيار كشاف',
  date_range: 'تحديد التاريخ',
  no_eligible_payments: 'لا توجد مستحقات',
  no_payment_history: 'لا يوجد سجل مدفوعات',
  all_from_last_paid: 'جميع المستحقات من آخر دفعة حتى اليوم',
  select_date_range_optional: 'تحديد التاريخ اختياري',
  call: 'اتصال',
  send_message: 'إرسال رسالة',
  copy: 'نسخ',
  copied_to_clipboard: 'تم النسخ إلى الحافظة',
  saved_successfully: 'تم الحفظ بنجاح',
  long_press_to_edit: 'اضغط مطولاً للتعديل',
  editing: 'جاري التعديل...',
  saving: 'جاري الحفظ...',
  schema_max_500_chars: 'يجب ألا يتجاوز 500 حرف',
  schema_max_1000_chars: 'يجب ألا يتجاوز 1000 حرف',
  schema_invalid_phone: 'رقم الهاتف غير صالح',
  add_phone: 'إضافة رقم هاتف',
  delete_phone: 'حذف رقم الهاتف',
  confirm_delete_phone: 'هل أنت متأكد من حذف هذا الرقم؟',
  queued_medicines: 'الأدوية المختارة',
  queued_medicines_hint: 'اضغط على الدواء لتعديله أو على الحذف لإزالته',
  queue_medicine_before_save: 'يرجى اختيار دواء واحد على الأقل قبل الحفظ',
  queued_family_members: 'أفراد العائلة المضافين',
  queued_family_members_hint: 'اضغط على الفرد لتعديله أو على الحذف لإزالته',
  queue_family_before_save: 'يرجى إضافة فرد عائلة واحد على الأقل قبل الحفظ',
  add_family_member_to_list: 'أضف الفرد إلى القائمة',
  sub_patient: 'مريض إضافي',
  sub_patients: 'المرضى الإضافيون',
  add_sub_patient: 'إضافة مريض إضافي',
  edit_sub_patient: 'تعديل مريض إضافي',
  manage_sub_patients: 'إدارة المرضى الإضافيون',
  no_sub_patients: 'لا يوجد مريضون إضافيون',
  sub_patient_details: 'تفاصيل المريض الإضافي',
