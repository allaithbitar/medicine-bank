...
type Props = Omit<ComponentProps<typeof FormTextFieldInput>, 'value' | 'onChange'> &
  TSharedFormComponentProps<number | string> & {
    allowDecimals?: boolean;
  };

function FormNumberInput({ onChange, value, allowDecimals = false, ...props }: Props) {
  return (
    <FormTextFieldInput
      {...props}
      ...
      value={value as any}
      onChange={(value) => {
        let _val: string | number = arabicToWesternDigits(value);
