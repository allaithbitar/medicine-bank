...
type Props = Omit<ComponentProps<typeof OutlinedInput>, 'value' | 'onChange'> & TSharedFormComponentProps<string>;

const FormTextFieldInput = ({ label, helperText, value, onChange, required, disabled, errorText, ...props }: Props) => {
  return (
