...
type Props<T extends TListItem, V extends boolean = false, Y extends boolean = false> = Omit<
...
> &
  ...
  Omit<TSharedFormComponentProps<TListItem>, 'value' | 'onChange'> & {
    ...
    multiple?: V;
    onChange?: V extends true ? (value: T[]) => void : (value: T | null) => void;
    value?: V extends true ? T[] : T | null;
  };

function FormAutocompleteInput<T extends TListItem, V extends boolean = false, Y extends boolean = false>({
  label,
  helperText,
  textFieldProps,
  options,
  ...
  return (
    ...
    >
      ...
      <Autocomplete
        ...
        renderInput={(renderInputProps) => <TextField error={!!errorText} {...renderInputProps} {...textFieldProps} />}
      />
