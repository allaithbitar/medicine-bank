...
export const getLocalDisclosureConsultation = async (id: string): Promise<TDisclosureAdviserConsultation | null> => {
  ...
  return (result as unknown as TDisclosureAdviserConsultation) || null;
};
...
export const useLocalDisclosureConsultationLoader = (id?: string, forceOffline = false) => {
  ...
  const queryResult = useQuery({
    ...
    queryFn: async () => getLocalDisclosureConsultation(id || ''),
