...
import accountsManagementApi from "../api/accounts-management.api";
import type { IOptions } from "@/core/types/common.types";
import { employeeAccountSchema } from "../schemas/employee-form-schema";
import { showError, showSuccess } from "@/core/components/common/toast/toast";
import WorkAreaAutoComplete from "@/features/banks/components/work-area-autocomplete/work-area-autocomplete.component";
...
const EmployeeAccountForm = () => {
  ...
  const [addEmployee] = accountsManagementApi.useAddEmployeeMutation();
