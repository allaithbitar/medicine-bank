  ...
  return (
    <Stack gap={2} sx={{ height: '100%' }}>
      <CustomAppBar
        ...
        children={<SearchFilter initialQuery={query} onSearch={handleSearch} placeholder={STRINGS.search_city} />}
      />
      <CitiesList isLoadingCities={isLoadingCities} cities={cities} onEdit={handleOpenCityActionPage} />
      <ActionsFab
        actions={[
          {
            label: STRINGS.add,
