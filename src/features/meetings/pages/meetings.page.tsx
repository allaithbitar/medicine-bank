...
const MeetingsPage = () => {
  ...
  const openActionPage = (oldMeeting?: any) => {
    navigate("/meetings/action", { state: { oldMeeting } });
  };

  return (
    <Stack gap={2} sx={{ height: "100%" }}>
      <CustomAppBar
        title={STRINGS.meetings_management}
        subtitle={STRINGS.add_manage_meetings}
      />
